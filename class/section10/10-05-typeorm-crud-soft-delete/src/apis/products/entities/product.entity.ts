...
export class Product {
  ...
  // @UpdateDateColumn() // 데이터 수정시 수정 시간 자동으로 추가 , CreateDateColumn과 짝으로 쓰임
  // updatedAt:Date

  @DeleteDateColumn() // typeORM이 제공해주는 삭제기능(소프트삭제 시간 기록을 위한 것)
  deletedAt: Date; // deletedAt 변수명은 바꿔도 됨, 위의 컬럼만 잘 작성한다면
}
