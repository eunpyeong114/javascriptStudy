...
// import 이렇게해도된다고 from "express"; // export default 가져오기 즉 이때는 변수명 중요치 않음
// import qqq, { checkPhone as zzzz, getToken, sendTokenToSMS } from "./phone.js"; //export와 export default 같이 섞여 가져올 때 // export도 as 사용하면 이름바꿔서 가져올 수 있음
...
app.use(express.json()); // api 에 하나 하나 설정을 등록해주고 싶을 때 use() 사용 // express.json()을 해야 JSON데이터 형태로 받아올 수 있게 해줌
