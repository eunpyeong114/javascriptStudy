...
// 풀이
const filter = "1234567890-_.qwertyuiopasdfghjklzxcvbnm";
...
function solution(new_id) {
  ...
  // 6단계 : 길이가 16자 이상이라면, 15자까지 자른다.
  //        잘라온 문자열 끝에 마침표가 존재한다면 제거한다.
  if (answer.length >= 16) {
    answer = answer.substring(0, 15);
    removeLastDot();
  }
  // 7단계 ㅣ 길이가 2글자 이하라면, 마지막 글자가 3글자가 될 때까지 반복해서 붙인다.
  if (answer.length <= 2) {
...
// 풀이 2
const filter2 = "1234567890-_.qwertyuiopasdfghjklzxcvbnm";
